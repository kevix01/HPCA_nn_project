...
public:
    ...
    std::vector<std::vector<float>> forwardCPUopenMP(const std::vector<std::vector<float>>& inputs, int samples_num_threads, int out_neurons_num_threads, int in_neurons_num_threads);
